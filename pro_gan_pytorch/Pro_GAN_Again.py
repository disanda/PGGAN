...
state_dict1 = torch.load('./result/pre-model/GAN_GEN_SHADOW_3.pth',map_location=device)
...
state_dict2 = torch.load('./result/pre-model/GAN_DIS_3.pth',map_location=device)
